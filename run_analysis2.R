...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjYzMTg0Mzk2OjFjY2NhMzM0YWIzNGJhNTU4MzQzMTA3MTA1NmJiYTUxZDkxZmM4OTMzMzBmM2I4MDUwOGI4YzkxNmI4ODhkZTM=--f907599f5a99b2d21147ccf28e90721133baafdc">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="F8C0:4A83:2EDBA3C:54E3C44:5AE374CF" data-pjax-transient>
...
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="50292410" data-scoped-search-url="/spujadas/getting-and-cleaning-data-course-project/search" data-unscoped-search-url="/search" action="/spujadas/getting-and-cleaning-data-course-project/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
    <label class="form-control header-search-wrapper  js-chromeless-input-container">
          <a class="header-search-scope no-underline" href="/spujadas/getting-and-cleaning-data-course-project/blob/master/run_analysis.R">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="V7ilVTV/GsK3TmcdKpV+ekRyf3APfPfZjNk3GEagwcx0Xyu0QYUkJj9Zq3Vs4pQBKTP81IznZy84WrW/zylX2g==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Vsp0au+7/Yqgs98Qh+cjnjXK1ukIIkJqgixsgaF2H3B1LfqLm0HDbiikE3jBkMnlWItVTYu50pw2r+4mKP+JZg==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="yBlDRWGBVLoEHFatg2k1BiqEvKXWF1Sshxj4KGCx6+40hvlhC1541uPGLc0ZKTrBR4RhMWvGJUeb8GI4PcHhFw==" />      <input type="hidden" name="repository_id" id="repository_id" value="50292410" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/spujadas/getting-and-cleaning-data-course-project/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="8oiOlU5KEX3ujEC2Op/5VlAC4YQhqlIojLmR2A9nFl22Ynuym7ncoQ5lftFUAinn5LJ3lJfDb6dNPeMcT7RwAw==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/spujadas/getting-and-cleaning-data-course-project/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="aUCr607DeO984JHGgsoR3AsgRaFHSn020P+64sigJlDdaLNYEo6zkEGTx5mbLDRsf+rGPhZZ4w8PffSjPx7ANw==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/spujadas/getting-and-cleaning-data-course-project/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="UAnzkGfv0AB+fGG7/hgEZg7MiDqdN8UNRgRrKzTqJEa2UVOWmhe5PxsVSJPr3ejtUV9EcEXgvRyxtMyUCeAxPg==" />
            <button
                type="submit"
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" href="/spujadas">spujadas</a></span><!--
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <include-fragment src="/spujadas/getting-and-cleaning-data-course-project/contributors/master/run_analysis.R" class="commit-tease">
    <div>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" href="/spujadas/getting-and-cleaning-data-course-project/blame/55b3ec72d228d9b60c69aa27f6fe36de48f881c1/run_analysis.R">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" href="/spujadas/getting-and-cleaning-data-course-project/issues/new">Open new issue</a></li>
      </ul>
    </div>
  </div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.31954s from unicorn-2123144889-r57lz">GitHub</span>, Inc.</li>
